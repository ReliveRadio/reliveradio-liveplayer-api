...
(function ($) {
	...
	var generateChapterTable = function (params) {
		...
		var div = $('<div class="podlovewebplayer_chapterbox showonplay"><table><caption>Podcast Chapters</caption><thead><tr><th scope="col">Chapter Number</th><th scope="col">Start time</th><th scope="col">Title</th><th scope="col">Duration</th></tr></thead><tbody id="jsonp_antwort"></tbody></table></div>'),
