...
setInterval( function jsonp(){
  ...
  var now = new Date(); url = "<?php echo $js_mix_ajax_link; ?>?time="+now.getTime()+"&anzahl=<?php  echo $liste; ?>&callback=callback";
...
setInterval( function jsonps(){
  ...
  var relivecoverurl = new Date(); url = "<?php echo $js_mix_ajax_link; ?>?time="+relivecoverurl.getTime()+"&relivecoverdata=relivecoverdata";
...
setInterval( function jsonps(){
  ...
  var relivetitletturl = new Date(); url = "<?php echo $js_mix_ajax_link; ?>?time="+relivetitletturl.getTime()+"&relivetitlenamedata=relivetitlenamedata";
