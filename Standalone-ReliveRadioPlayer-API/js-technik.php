...
setInterval(function jsonp(){
  ...
  var now = new Date(); url = "<?php echo $js_ajax_link_tec; ?>?time="+now.getTime()+"&anzahl=<?php  echo $liste; ?>&callback=callback";
...
setInterval(function jsonps(){
  ...
  var relivecoverurl = new Date(); url = "<?php echo $js_ajax_link_tec; ?>?time="+relivecoverurl.getTime()+"&relivecoverdata=relivecoverdata";
...
}, <?php echo $setup_ms_callback; ?>); function relivecoverdata(data) { document.getElementById("ReLiveCover").innerHTML = data; }

/**
*	Callback Title (Technik)
*/
setInterval( function jsonps(){
  ...
  var relivetitletturl = new Date(); url = "<?php echo $js_ajax_link_tec; ?>?time="+relivetitletturl.getTime()+"&relivetitlenamedata=relivetitlenamedata";
...
}, <?php echo $setup_ms_callback; ?>); function relivetitlenamedata(data) { document.getElementById("ReLiveTitle").innerHTML = data; }
